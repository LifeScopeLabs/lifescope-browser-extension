		...
		<div class="boxed-group">
			...
			<div class="padded paragraphed mobile-margin">
				...
				<p v-if="browserName === 'Chrome' || browserName === 'Firefox'">
					When you add a domain or URL to the whitelist, all visits to that domain or URL will be indexed from your browser.
				</p>
				...
				<div v-if="$data.connection && $data.connection.enabled === false">
					...
					<div>
						...
						<p>Any new domains or URLs that you add to the list will not be indexed until the Browser Extension Connection is enabled.</p>
					</div>
				</div>
				<div class="whitelist">
